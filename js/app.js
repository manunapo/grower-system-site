...
//             "firstname" == o.attr("name") || "lastname" == o.attr("name") ? (e.insertAfter($("#lastname").closest(".row")),
//             o.parents("div.form-group").addClass("has-error")) : "password" == o.attr("name") || "retype_password" == o.attr("name") ? (e.insertAfter($("#retype_password").closest(".row")),
//             o.parents("div.form-group").addClass("has-error")) : "agree" == o.attr("name") ? e.insertAfter("#agree-text") : e.insertAfter(o)
//         },
//         messages: {
